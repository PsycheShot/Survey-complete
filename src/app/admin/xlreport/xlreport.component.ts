  ...
  ngOnInit(): void {
    this.qdb.getTopicId().subscribe(res=>{
      ...
      for(let t of res){
        ...
        this.topicName.push(t.topicName)
        let rtemp:Rdata[]=[];
      ...
      for(let i=0;i<this.tidarr.length;){
        //console.log(this.tidarr[i])
        this.qdb.getqbytid(this.tidarr[i]).subscribe(resp=>{
          for(let e of resp[0].data){
            ...
            this.qdb.getCountByIdRef(this.tidarr[i-1],e.ref,'Present status in Karnataka').subscribe(r1=>{
            ...
            this.qdb.getCountByIdRef(this.tidarr[i-1],e.ref,'Nature of Implication').subscribe(r2=>{
            ...
            this.qdb.getCountByIdRef(this.tidarr[i-1],e.ref,'Implementation Timeline').subscribe(r3=>{
